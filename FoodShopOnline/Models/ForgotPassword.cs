...
namespace FoodShopOnline.Models
{
    public class ForgotPassword
    {
        ...
        //Lấy lại mật khẩu
        public string BodyMail_LayLaiMatKhau(string Email, string Name)
        {
            StringBuilder mailbody = new StringBuilder();
            mailbody.Append("<html><head><title>Mã xác thực tài khoản</title></head>");
            mailbody.Append("<body>");
            mailbody.Append("<p>Chào bạn</p>");
            mailbody.Append("<p>Thông tin tài khoản của bạn: </p>");
            mailbody.Append("<p><b>Tên đăng nhập: </b>" + Name);
